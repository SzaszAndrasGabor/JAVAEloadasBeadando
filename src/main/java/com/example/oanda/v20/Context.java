...
import com.example.oanda.v20.instrument.InstrumentContext;
import com.example.oanda.v20.position.PositionContext;
import com.example.oanda.v20.trade.TradeContext;
import com.example.oanda.v20.account.AccountContext;
import com.example.oanda.v20.transaction.TransactionContext;
import com.example.oanda.v20.transaction.Transaction;
import com.example.oanda.v20.transaction.TransactionAdapter;
import com.example.oanda.v20.user.UserContext;
import com.example.oanda.v20.pricing.PricingContext;
import com.example.oanda.v20.order.OrderContext;
import com.example.oanda.v20.order.Order;
import com.example.oanda.v20.order.OrderAdapter;
import com.example.oanda.v20.primitives.NullableTypeAdapterFactory;
import com.example.oanda.v20.primitives.AcceptDatetimeFormat;
    ...
    public Context(
        ...
        this.gson = new GsonBuilder()
            ...
            .registerTypeAdapterFactory(
                new NullableTypeAdapterFactory<com.example.oanda.v20.transaction.TakeProfitDetails>(
                    com.example.oanda.v20.transaction.TakeProfitDetails.class
                )
            )
            .registerTypeAdapterFactory(
                new NullableTypeAdapterFactory<com.example.oanda.v20.transaction.StopLossDetails>(
                    com.example.oanda.v20.transaction.StopLossDetails.class
                )
            )
            .registerTypeAdapterFactory(
                new NullableTypeAdapterFactory<com.example.oanda.v20.transaction.TrailingStopLossDetails>(
                    com.example.oanda.v20.transaction.TrailingStopLossDetails.class
                )
            )
            .create();
